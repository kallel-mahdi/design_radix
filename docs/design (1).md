...
> **Source of truth**: `editor-layouts-corrected.html`

| Element | rem | px | Weight | Notes |
|---------|-----|-----|--------|-------|
| **Sidebar title** | 0.75rem | 12px | 600 | Uppercase, letter-spacing 0.05em |
| **Section header** | 0.875rem | 14px | 600 | "My Library", "File Browser" |
| **File/Collection item** | 0.875rem | 14px | 400 | Tree items |
| **Outline item** | 0.8125rem | 13px | 400 | Document outline |
| **Button label** | 0.8125rem | 13px | 500 | Action buttons |
| **Tab label** | 0.8125rem | 13px | 400 | Dockview tabs |
...
| **Sidebar footer btn** | 0.75rem | 12px | 400 | Editor settings buttons |
| **Zoom value** | 0.75rem | 12px | 500 | PDF zoom percentage |
| **Toolbar button** | 0.875rem | 14px | 600 | B/I formatting buttons |
...
─────────────────────────────────────────────────────────
Font scale: 11px (tags) → 12px (sidebar title/table header) → 13px (tabs/buttons/outline) → 14px (body/items)
─────────────────────────────────────────────────────────
```
