 ...
 * Resizable Component
 *
 * Wrapper around react-resizable-panels for resizable panel layouts.
 * Styled with bibliography design system colors.
 */
...
const ResizableHandle = ({
  ...
  <ResizablePrimitive.PanelResizeHandle
    className={cn(
      'relative flex w-px items-center justify-center after:absolute after:inset-y-0 after:left-1/2 after:w-1 after:-translate-x-1/2',
      'hover:after:bg-accent/50',
